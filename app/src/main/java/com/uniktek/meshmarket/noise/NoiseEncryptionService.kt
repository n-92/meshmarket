package com.uniktek.meshmarket.noise

import android.content.Context
import android.util.Log
import com.uniktek.meshmarket.identity.SecureIdentityStateManager
import com.uniktek.meshmarket.mesh.PeerFingerprintManager
import com.uniktek.meshmarket.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.uniktek.meshmarket.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour (same as iOS)
        private const val REKEY_MESSAGE_LIMIT = com.uniktek.meshmarket.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION // 1k messages (matches iOS) (same as iOS)
    }
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = com.uniktek.meshmarket.noise.southernstorm.protocol.Noise.createDH("25519")
     ...
     */
    fun signPacket(packet: com.uniktek.meshmarket.protocol.BitchatPacket): com.uniktek.meshmarket.protocol.BitchatPacket? {
     ...
     */
    fun verifyPacketSignature(packet: com.uniktek.meshmarket.protocol.BitchatPacket, publicKey: ByteArray): Boolean {
