package com.uniktek.meshmarket.nostr
...
import com.uniktek.meshmarket.model.PrivateMessagePacket
import com.uniktek.meshmarket.protocol.BitchatPacket
import com.uniktek.meshmarket.services.SeenMessageStore
import com.uniktek.meshmarket.ui.ChatState
import com.uniktek.meshmarket.ui.MeshDelegateHandler
import com.uniktek.meshmarket.ui.PrivateChatManager
...
class NostrDirectMessageHandler(
    ...
    private val dataManager: com.uniktek.meshmarket.ui.DataManager
) {
    ...
    fun onGiftWrap(giftWrap: NostrEvent, geohash: String, identity: NostrIdentity) {
        scope.launch(Dispatchers.Default) {
            try {
                ...
                if (packet.type != com.uniktek.meshmarket.protocol.MessageType.NOISE_ENCRYPTED.value) return@launch
                ...
                com.uniktek.meshmarket.nostr.GeohashAliasRegistry.put(convKey, senderPubkey)
        ...
        when (payload.type) {
            ...
            NoisePayloadType.FILE_TRANSFER -> {
                ...
                if (file != null) {
                    ...
                    val savedPath = com.uniktek.meshmarket.features.file.FileUtils.saveIncomingFile(application, file)
                    val message = BitchatMessage(
                        id = uniqueMsgId,
                        sender = senderNickname,
                        content = savedPath,
