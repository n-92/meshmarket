...
import com.uniktek.meshmarket.nostr.GeohashMessageHandler
import com.uniktek.meshmarket.nostr.GeohashRepository
import com.uniktek.meshmarket.nostr.NostrDirectMessageHandler
import com.uniktek.meshmarket.nostr.NostrIdentityBridge
import com.uniktek.meshmarket.nostr.NostrProtocol
import com.uniktek.meshmarket.nostr.NostrRelayManager
import com.uniktek.meshmarket.nostr.NostrSubscriptionManager
import com.uniktek.meshmarket.nostr.PoWPreferenceManager
import com.uniktek.meshmarket.nostr.GeohashAliasRegistry
import com.uniktek.meshmarket.nostr.GeohashConversationRegistry
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.uniktek.meshmarket.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.uniktek.meshmarket.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.uniktek.meshmarket.geohash.ChannelID.Mesh)
    ...
    fun sendGeohashMessage(content: String, channel: com.uniktek.meshmarket.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = com.uniktek.meshmarket.model.BitchatMessage(
                    id = tempId,
                ...
                if (startedMining) {
                    com.uniktek.meshmarket.ui.PoWMiningTracker.startMiningMessage(tempId)
                }
                try {
                    ...
                    if (startedMining) {
                        com.uniktek.meshmarket.ui.PoWMiningTracker.stopMiningMessage(tempId)
                    }
                }
            } catch (e: Exception) {
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.uniktek.meshmarket.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.uniktek.meshmarket.model.BitchatMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.uniktek.meshmarket.geohash.ChannelID?) {
