            ...
            Column(
                ...
                LazyColumn(
                    ...
                    if (selectedMessage?.sender != viewModel.nickname.value) {
                        ...
                        item {
                            UserActionRow(
                                title = stringResource(R.string.action_view_profile_title, targetNickname),
                                subtitle = stringResource(R.string.action_view_profile_subtitle),
                                titleColor = standardBlue,
                                onClick = {
                                    val peerID = selectedMessage?.senderPeerID ?: viewModel.getPeerIDForNickname(targetNickname)
                                    if (peerID != null) {
                                        viewModel.showProfileSheet(peerID)
                                    }
                                    onDismiss()
                                }
                            )
