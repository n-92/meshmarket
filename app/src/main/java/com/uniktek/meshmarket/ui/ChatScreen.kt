...
import com.uniktek.meshmarket.ui.media.FullScreenImageViewer
...
fun ChatScreen(viewModel: ChatViewModel) {
    ...
    val displayMessages = when {
        currentChannel != null -> channelMessages[currentChannel] ?: emptyList()
            ...
            if (locationChannel is com.uniktek.meshmarket.geohash.ChannelID.Location) {
    ...
    val showMediaButtons = when {
        ...
        else -> selectedLocationChannel !is com.uniktek.meshmarket.geohash.ChannelID.Location
    }
        ...
        Column(
            ...
            MessagesList(
                ...
                onNicknameClick = { fullSenderName ->
                    ...
                    val mentionText = if (selectedLocationChannel is com.uniktek.meshmarket.geohash.ChannelID.Location && hashSuffix.isNotEmpty()) {
    ...
    androidx.compose.runtime.LaunchedEffect(Unit) {
        com.uniktek.meshmarket.ui.events.FileShareDispatcher.setHandler { peer, channel, path ->
    ...
    ChatInputSection(
        ...
        onSendVideoNote = { peer, onionOrChannel, path ->
            viewModel.sendVideoNote(peer, onionOrChannel, path)
        },
            ...
            Surface(
                ...
                IconButton(onClick = { forceScrollToBottom = !forceScrollToBottom }) {
                    Icon(
                        ...
                        contentDescription = stringResource(com.uniktek.meshmarket.R.string.cd_scroll_to_bottom),
...
fun ChatInputSection(
    ...
    onSendVideoNote: (String?, String?, String) -> Unit,
...
private fun ChatFloatingHeader(
    ...
    val locationManager = remember { com.uniktek.meshmarket.geohash.LocationChannelManager.getInstance(context) }
...
private fun ChatDialogs(
    ...
    if (showDebugSheet) {
        com.uniktek.meshmarket.ui.debug.DebugSettingsSheet(
    ...
    // Marketplace sheets
    val showMyListingsSheet by viewModel.showMyListingsSheet.collectAsStateWithLifecycle()
    val showProfileSheet by viewModel.showProfileSheet.collectAsStateWithLifecycle()

    if (showMyListingsSheet) {
        com.uniktek.meshmarket.ui.marketplace.MyListingsSheet(
            isPresented = true,
            viewModel = viewModel,
            onDismiss = { viewModel.hideMyListingsSheet() }
        )
    }

    if (showProfileSheet != null) {
        com.uniktek.meshmarket.ui.marketplace.PeerProfileSheet(
            peerID = showProfileSheet,
            viewModel = viewModel,
