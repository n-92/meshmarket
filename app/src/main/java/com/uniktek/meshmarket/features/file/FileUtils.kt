package com.uniktek.meshmarket.features.file
...
object FileUtils {
    ...
    fun saveIncomingFile(
        context: Context,
        file: com.uniktek.meshmarket.model.BitchatFilePacket
    ): String {
     ...
     */
    fun messageTypeForMime(mime: String): com.uniktek.meshmarket.model.BitchatMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.uniktek.meshmarket.model.BitchatMessageType.Image
            lower.startsWith("audio/") -> com.uniktek.meshmarket.model.BitchatMessageType.Audio
            lower.startsWith("video/") -> com.uniktek.meshmarket.model.BitchatMessageType.Video
            else -> com.uniktek.meshmarket.model.BitchatMessageType.File
        }
    }
