...
class BluetoothPacketBroadcaster(
    ...
    companion object {
        ...
        private const val CLEANUP_DELAY = com.uniktek.meshmarket.util.AppConstants.Mesh.BROADCAST_CLEANUP_DELAY_MS
    }
    ...
    private fun logPacketRelay(
        ...
        try {
            ...
            val manager = com.uniktek.meshmarket.ui.debug.DebugSettingsManager.getInstance()
            ...
            if (fragments.size > 1) {
                ...
                val job = connectionScope.launch {
                    ...
                    fragments.forEach { fragment ->
                        ...
                        // 50ms delay between fragments for BLE reliability
                        delay(50)
                        if (transferId != null) {
                            sent += 1
