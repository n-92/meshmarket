 ...
 * 
 * This class handles all relay decisions and logic for MeshMarket packets.
...
class PacketRelayManager(private val myPeerID: String) {
    ...
    private fun isRelayEnabled(): Boolean = try {
        com.uniktek.meshmarket.ui.debug.DebugSettingsManager.getInstance().packetRelayEnabled.value
