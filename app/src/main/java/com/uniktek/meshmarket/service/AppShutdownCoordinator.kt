...
object AppShutdownCoordinator {
    ...
    fun requestFullShutdownAndKill(
        ...
        val job = scope.launch {
            ...
            try {
                val intent = android.content.Intent(com.uniktek.meshmarket.util.AppConstants.UI.ACTION_FORCE_FINISH)
                    .setPackage(app.packageName)
                app.sendBroadcast(intent, com.uniktek.meshmarket.util.AppConstants.UI.PERMISSION_FORCE_FINISH)
            } catch (_: Exception) { }
            ...
            try { com.uniktek.meshmarket.services.AppStateStore.clear() } catch (_: Exception) { }
