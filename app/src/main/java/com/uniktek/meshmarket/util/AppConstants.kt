package com.uniktek.meshmarket.util
...
object AppConstants {
    ...
    object Fragmentation {
        ...
        const val FRAGMENT_TIMEOUT_MS: Long = 300_000L   // 5 minutes for large media transfers
        const val CLEANUP_INTERVAL_MS: Long = 30_000L
        const val MAX_FRAGMENTS_PER_ID: Int = 65535       // Full UInt16 range for media support
        const val MAX_FRAGMENT_TOTAL_BYTES: Int = 10_485_760 // 10 MB per fragment set
        const val MAX_ACTIVE_FRAGMENT_SETS: Int = 16
        const val MAX_GLOBAL_FRAGMENT_TOTAL_BYTES: Long = 20L * 1_048_576L // 20 MB global
    }
    ...
    object UI {
        ...
        const val ACTION_FORCE_FINISH: String = "com.uniktek.meshmarket.ACTION_FORCE_FINISH"
        const val PERMISSION_FORCE_FINISH: String = "com.uniktek.meshmarket.permission.FORCE_FINISH"
    }
